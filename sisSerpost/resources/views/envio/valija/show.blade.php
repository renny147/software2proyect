                       ...
                       <thead style="background-color: #B2FFFF">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <a href="{{URL::action('EnvioEncomiendaController@show',$detalle->idenvio_encomienda)}}"><button class="btn btn-primary">Detalles Envio</button></a></td>
                          </tr>
                          @endforeach
                        </tbody>
                  </table>
